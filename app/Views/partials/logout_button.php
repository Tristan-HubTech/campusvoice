<?php
$logoutUrl = $logoutUrl ?? site_url('users/logout');
$logoutLabel = $logoutLabel ?? 'Logout';
?>
<a href="<?= $logoutUrl ?>" class="logout-link logout-link--icon" title="<?= esc($logoutLabel, 'attr') ?>" aria-label="<?= esc($logoutLabel, 'attr') ?>">
