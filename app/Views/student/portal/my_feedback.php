...
<div class="portal-page narrow">
    ...
    <div class="announce-hero">
        ...
        <div class="announce-hero__text">
            <h1 class="announce-hero__title">My Voice</h1>
            <p class="announce-hero__sub">Track statuses and read admin replies on each submission.</p>
        </div>
                ...
                <div class="myfb-card__inner">
                    ...
                    <div class="myfb-card__footer">
                        ...
                        <div class="myfb-card__actions">
                            <button type="button" class="myfb-btn myfb-btn--copy" onclick="navigator.clipboard.writeText('<?= esc($refNum) ?>'); let t = this.innerHTML; this.innerHTML = '<svg width=\'13\' height=\'13\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'2\' stroke-linecap=\'round\' stroke-linejoin=\'round\'><polyline points=\'20 6 9 17 4 12\'></polyline></svg> Copied!'; setTimeout(() => this.innerHTML = t, 1500);">
